...
<div class="container-fluid" style="background-color:lavenderblush";>
          ...
          <h1 class="h1_index text-center">Edit Admin Details</h1>
		   ...
		   <br>
        <div class="col-sm-10">
		<h4>Note: Password is confidential hence can not be edited here if you want change then <a href="../include/forgetpassword.php">Recover Password</a>.</h4>
...
$con = mysqli_connect('localhost','ferroknb_cliff','Juxby2019/','ferroknb_crypto');
